...
import { fetchEventForPostMortem, fetchAttendeesForPostMortem, hasEventEnded } from "./data.js";
...
export async function runGeneration(fastify, { eventId, eventName, requestedBy }) {
  ...
  try {
    ...
    const pdfBuffer = await renderPostMortemPdf({ event, stats, generatedByName, generatedAt });
